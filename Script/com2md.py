...
class BibleChapter:
	...
	def buildMdBible(self,bibleAbbrev,bookName,bookAbbrev,bookStandardName,bookStandardAbbrev,bookEnglishName,path):
		...
		f.write('# '+bookName+' '+self.number+'\n\n')
		f.write('```query'+'\n')
		f.write('/\[\['+bookAbbrev+' '+self.number+'(\|.*)?\]\]/ -file:"'+bibleAbbrev+' '+bookAbbrev+' '+self.number+'"'+'\n')
		f.write('```'+'\n'+'\n')
		f.write('\n\n')
...
Commentaires = Bible("Bible Commentée","COM",False,"français","ltr")
